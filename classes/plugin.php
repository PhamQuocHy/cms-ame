...
class Plugin
{
	...
	public function admin_init()
	{
		...
		add_settings_field(
			'whl_page',
			'<label for="whl_page">' . __('URL đăng nhập', 'wps-hide-login') . '</label>',
		...
		add_settings_field(
			'whl_redirect_admin',
			'<label for="whl_redirect_admin">' . __('URL chuyển hướng', 'wps-hide-login') . '</label>',
